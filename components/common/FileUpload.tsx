...
const FileUpload: React.FC<FileUploadProps> = ({ onFilesUploaded, acceptedFileTypes, maxFileSizeMB, enableDirectoryUpload = true }) => {
  ...
  const onDrop = useCallback(async (e: React.DragEvent<HTMLDivElement>) => {
    ...
    try {
        ...
        // FIX: Cast item to 'any' to access the non-standard 'webkitGetAsEntry' property.
        ...
        {isProcessing ? (
            ...
            <div className="pointer-events-none">
                ...
                <button
                    ...
                    className="font-semibold text-cyan-400 bg-transparent border-none p-0 underline hover:no-underline pointer-events-auto"
                >
