...
class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  // FIX: State is initialized as a class property to resolve compiler errors where 'state' and 'props' were not being recognized on the component instance.
  state: ErrorBoundaryState = {
    hasError: false,
    error: undefined,
  };

  // FIX: Add an explicit constructor to ensure 'this.props' is correctly typed and recognized by the compiler.
